...
import com.Portfolio.JiArrighi.Dto.dtoPersona;
import com.Portfolio.JiArrighi.Security.Controller.Mensaje;
import com.Portfolio.JiArrighi.entity.Persona;
import com.Portfolio.JiArrighi.service.ImpPersonaService;
...
public class PersonaController {
  ...
  @PostMapping("/create")
    ...
    public ResponseEntity<Persona> update(@PathVariable("id") int id, @RequestBody dtoPersona dtopersona) {
