...
import com.Portfolio.JiArrighi.Dto.dtoExperiencia;
import com.Portfolio.JiArrighi.Security.Controller.Mensaje;
import com.Portfolio.JiArrighi.entity.Experiencia;
import com.Portfolio.JiArrighi.service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp) {
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getEmpresaE(), dtoexp.getDescripcionE(), dtoexp.getInicioE(), dtoexp.getFinE(), dtoexp.getLogoE());
